...
public class TesstEmployeeHibernetNamedQuery {
...
//	@Test
	...
	public void testFindingEmployeesBySalary() {
		List<Employee> employees = repo.findBySalary(2000d);
		assertEquals("should return one emp with name", employees.size(), 2);
	}
